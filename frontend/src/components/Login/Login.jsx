  ...
  return (
    ...
    <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center ">
     <div className="bg-white rounded-2xl shadow-2xl flex w-full md:w-2/3 max-w-4xl justify-center">
           ...
           <div className="py-10">
            ...
            <div className='flex flex-col items-center'>
              ...
              <label className={`${styles.noramlFlex} text-xs`}>
                ...
                className="text-xs text-gray-900 hover:text-blue-500 ">Forgot Password?</a>
              </div>
              <button className='border-2 border-blue-950 rounded-full px-12 py-2 inline-block font-semibold text-blue-950 hover:bg-blue-950 hover:text-white'>Login</button>
              </div>
            </div>
          </div>
          ...
          <div className="w-2/5 bg-blue-950 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12 hidden md:block">
          <h2 className="text-3xl font-bold mb-2">Hello, Friend!</h2>
          <div className="border-2 w-10 border-white inline-block mb-2"></div>
          <p className="mb-10">Fill up personal information and start journey with us.</p>
          <Link to="/sign-up" className="border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-blue-950">
            <p>Sign Up</p>
            </Link>
            </div>
     </div>    
